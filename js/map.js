...
class Themap {
    ...
    * @param {object} service - Google Places.
    * @param {object} markers - Tableau contenant les différents markers.
    * @param {object} data - Tableau contenant les données des restaurants.
    * @param {object} coordoneees - Coordonnées d'un point.
    * @param {number} indexActif - Index du restaurant actif dans le tableau.
    */
        constructor() {
            this.map = null;
            this.lat = 48.8737815;
